...
const calculateLoanSummary = (amount, rate, installments, emiAmount) => {
  ...
  const calculateEMI = (amount, rate, installments) => {
    const monthlyRate = (rate / 12) / 100;
    const emi = amount * monthlyRate * Math.pow(1 + monthlyRate, installments) / 
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Plan your loan repayment with our easy-to-use EMI calculator. Get detailed installment schedules and export your plan in just a few clicks.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Get precise EMI calculations based on your loan amount and interest rate.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-blue-600 text-2xl mb-3">📈</div>
            <h3 className="text-lg font-semibold mb-2">Detailed Schedule</h3>
            <p className="text-gray-600">View complete breakdown of principal and interest for each payment.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-blue-600 text-2xl mb-3">📥</div>
            <h3 className="text-lg font-semibold mb-2">Export Data</h3>
            <p className="text-gray-600">Download your payment schedule in CSV format for your records.</p>
          </div>
        </div>
    ...
    <div className="mt-8 bg-yellow-50 p-4 rounded-lg">
      ...
      <ul className="list-disc list-inside space-y-2 text-yellow-800">
        ...
        <div className="mt-12 text-center text-gray-600">
          <p className="text-sm">
            Note: This calculator provides approximate values. Please consult with your financial advisor for exact terms.
          </p>
        </div>
      </div>
    </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                Making loan calculations simple and accessible for everyone. Your trusted partner in financial planning.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">EMI Calculator</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Personal Loan</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Home Loan</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Car Loan</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Business Loan</a></li>
              </ul>
            </div>
